...
/**
 * Provides the local service interface for SiteConfig. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SiteConfigLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SiteConfigLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.zpharma.service.impl.SiteConfigLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the site config local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SiteConfigLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SiteConfig saveOrUpdateSiteConfiguration(SiteConfig siteConfig)
		throws PortalException;

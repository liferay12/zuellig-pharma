...
.notifications{margin-top:-2px;}
.section-slider .carousel-item.active::before{
...
.section-slider .carousel-caption p{font-size:15px;}
}
</style>
   ...
   <div class="carousel-inner text-break" id="_carouselInner" role="group">
      ...
      <div class="carousel-item active">
         ...
         <div class="carousel-item">
            ...
            <img alt="${title.carouselImage.getAttribute("alt")}" class="banner-image" data-fileentryid="${title.carouselImage.getAttribute("fileEntryId")}" src="${title.carouselImage.getData()}" />
            </#if>
            <div class="carousel-caption">
               <div class="container">
                  <div class="row text-left">
                        ...
                        <#if title.getData()!="">
                        <h1 class="col-md-8" data-lfr-editable-id="01-02-title" data-lfr-editable-type="rich-text">
                           ${title.getData()}
                        </h1>
                        </#if>
                        <#if title.subTitle.getData()!="">
                        <div class="lead col-md-6 mb-4" data-lfr-editable-id="01-03-subtitle" data-lfr-editable-type="rich-text">
                           <p class="text-body">
                              ${title.subTitle.getData()}
                           </p>
                           <#if title.link.getData()!="">
                        <a class="btn btn-primary" data-lfr-editable-id="01-04-link" data-lfr-editable-type="link" href="${title.link.getData()}" target="_blank" id="fragment-1-01-04-link">
                        View Details
                        </a>
                        </#if>
                        </div>
